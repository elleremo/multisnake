...
!function (e, t, n) {
  ...
  function d (t, r) {
    ...
    if ('CSSSupportsRule' in e) {
      ...
      return i = i.join(' or '), l('@supports (' + i + ') { #modernizr { position: absolute; } }', function (e) {return 'absolute' === c(e, null, 'position')})
    }
    return n
  }
  ...
  var k = function () {
    ...
    return t ? function (e) {
      ...
      var n = !1
      return l('@media ' + t + ' { #modernizr { position: absolute; } }', function (t) {n = 'absolute' === (e.getComputedStyle ? e.getComputedStyle(t, null) : t.currentStyle).position}), n
    }
  }()
  w.mq = k
  var B = function (e, t) {
